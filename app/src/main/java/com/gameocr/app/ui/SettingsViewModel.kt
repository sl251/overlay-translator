...
class SettingsViewModel @Inject constructor(
    ...
    suspend fun save(
        ...
        floatingButtonLandscapeEdgeFix: Boolean,
        floatingButtonLandscapeEdgeFixDp: Int,
        allowWrap: Boolean,
        ...
        repo.update {
            it.copy(
                ...
                floatingButtonLandscapeEdgeFix = floatingButtonLandscapeEdgeFix,
                floatingButtonLandscapeEdgeFixDp = floatingButtonLandscapeEdgeFixDp.coerceIn(0, 60),
